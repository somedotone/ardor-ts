...
export declare enum ParentTransactionType {
    CHILDCHAIN_BLOCK = -1,
    PAYMENT = -2,
    ACCOUNT_CONTROL = -3,
    COIN_EXCHANGE = -4
}
export declare enum ParentTransactionSubtype {
    CHILDCHAIN_BLOCK = 0,
    PAYMENT__ORDINARY_PAYMENT = 0,
    ACCOUNT_CONTROL__EFFECTIVE_BALANCE_LEASING = 0
}
export declare enum ChildTransactionType {
    PAYMENT = 0,
    MESSAGING = 1,
    ASSET_EXCHANGE = 2,
    DIGITAL_GOODS = 3,
...
export declare enum ChildTransactionSubtype {
    PAYMENT__ORDINARY_PAYMENT = 0,
